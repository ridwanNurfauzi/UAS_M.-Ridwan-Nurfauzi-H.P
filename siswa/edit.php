            ...
            <div class="card-body">
                ...
                <form action="../siswa/proses.php" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input" type="radio" name="jenis_kelamin" id="lk" value="Laki-laki" <?php if($jenis_kelamin == "Laki-laki") echo "checked"; ?>>
                                <label class="custom-control-label" for="lk">Laki-laki</label> 
                            </div>
                            <div class="custom-control custom-radio">
                                <input  class="custom-control-input" type="radio" name="jenis_kelamin" id="pr" value="Perempuan" <?php if($jenis_kelamin == "Perempuan") echo "checked"; ?>>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="alamat" id="alamat" rows="3" class="form-control"><?php
                            echo $alamat;
                            ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select name="jurusan" id="jurusan" class="form-control">
                                ...
                                <option value="TKRO" <?php if($jurusan == "TKRO")echo "selected"; ?>>TKRO</option>
                                <option value="TBSM" <?php if($jurusan == "TBSM")echo "selected"; ?>>TBSM</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
